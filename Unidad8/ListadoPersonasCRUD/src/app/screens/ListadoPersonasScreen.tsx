...
export const ListadoPersonasScreen = observer(function ListadoPersonasScreen({ navigation }: Props) {
  ...
  if (viewModel.error) {
    return (
      <View style={styles.centerContainer}>
        ...
        <TouchableOpacity style={styles.retryButton} onPress={() => viewModel.loadPersonas()}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <PersonaListItem
            ...
            onDelete={() => viewModel.deletePersona(item.id)}
          />
        )}
